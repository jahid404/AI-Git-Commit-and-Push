...
function activate(context) {
    ...
    if (workspaceFolder && autoStart) {
        ...
        autoCommit({ showInfoIfNoChanges: false });
    } else if (workspaceFolder && !autoStart) {
        vscode.window.showInformationMessage(`${msgPrefix} Auto-commit is disabled on startup. Use the "Commit" or "Restart" command to start.`);
    }
